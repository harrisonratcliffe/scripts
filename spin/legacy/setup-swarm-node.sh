...
if id -u admin >/dev/null 2>&1; then
    ...
    # Create the user with a different primary group and add to sudo and docker groups
    sudo useradd -m -s /bin/bash -g users -G docker,sudo admin
    echo "User 'admin' created and added to the 'docker' and 'sudo' groups."
fi
echo ""
